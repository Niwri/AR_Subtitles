...
class FREAK(cv2.Feature2D):
    # Functions
    @classmethod
    def create(cls, orientationNormalized: bool = ..., scaleNormalized: bool = ..., patternScale: float = ..., nOctaves: int = ..., selectedPairs: typing.Sequence[int] = ...) -> FREAK: ...
...
class PCTSignatures(cv2.Algorithm):
    ...
    @classmethod
    @typing.overload
    def create(cls, initSamplingPoints: typing.Sequence[cv2.typing.Point2f], initSeedCount: int) -> PCTSignatures: ...
    @classmethod
    @typing.overload
    def create(cls, initSamplingPoints: typing.Sequence[cv2.typing.Point2f], initClusterSeedIndexes: typing.Sequence[int]) -> PCTSignatures: ...
    ...
    def computeSignatures(self, images: typing.Sequence[cv2.typing.MatLike], signatures: typing.Sequence[cv2.typing.MatLike]) -> None: ...
    ...
    @staticmethod
    def generateInitPoints(initPoints: typing.Sequence[cv2.typing.Point2f], count: int, pointDistribution: int) -> None: ...
    ...
    def getSamplingPoints(self) -> typing.Sequence[cv2.typing.Point2f]: ...

    def setWeight(self, idx: int, value: float) -> None: ...

    def setWeights(self, weights: typing.Sequence[float]) -> None: ...

    def setTranslation(self, idx: int, value: float) -> None: ...

    def setTranslations(self, translations: typing.Sequence[float]) -> None: ...

    def setSamplingPoints(self, samplingPoints: typing.Sequence[cv2.typing.Point2f]) -> None: ...

    def getInitSeedIndexes(self) -> typing.Sequence[int]: ...

    def setInitSeedIndexes(self, initSeedIndexes: typing.Sequence[int]) -> None: ...
...
class PCTSignaturesSQFD(cv2.Algorithm):
    ...
    def computeQuadraticFormDistances(self, sourceSignature: cv2.typing.MatLike, imageSignatures: typing.Sequence[cv2.typing.MatLike], distances: typing.Sequence[float]) -> None: ...
...
# Functions
def matchGMS(size1: cv2.typing.Size, size2: cv2.typing.Size, keypoints1: typing.Sequence[cv2.KeyPoint], keypoints2: typing.Sequence[cv2.KeyPoint], matches1to2: typing.Sequence[cv2.DMatch], withRotation: bool = ..., withScale: bool = ..., thresholdFactor: float = ...) -> typing.Sequence[cv2.DMatch]: ...

def matchLOGOS(keypoints1: typing.Sequence[cv2.KeyPoint], keypoints2: typing.Sequence[cv2.KeyPoint], nn1: typing.Sequence[int], nn2: typing.Sequence[int], matches1to2: typing.Sequence[cv2.DMatch]) -> None: ...
